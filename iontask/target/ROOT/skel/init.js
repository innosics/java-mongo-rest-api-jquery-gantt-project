			...
			layers: {
				...
				// Title Bar.
					titleBar: {
						breakpoints: 'small',
						height: 44,
						html: '<span class="toggle" data-action="toggleLayer" data-args="navPanel"></span><a href="javascript:switchWorkspace();"><span id="defaultWorkspaceNameLogo" name="defaultWorkspaceNameLogo" class="title" data-action="copyText" data-args="logo"></span></a>',
						position: 'top-left',
						side: 'top',
						width: '100%'
					}
